...
class _ProductApiService implements ProductApiService {
  ...
  @override
  Future<HttpResponse<dynamic>> storeProduct(
  ...
  @override
  Future<HttpResponse<dynamic>> getProductDetail(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<HttpResponse<dynamic>> deleteProduct(String id) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
